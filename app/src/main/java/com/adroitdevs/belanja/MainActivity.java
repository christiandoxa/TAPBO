...
public class MainActivity extends AppCompatActivity {
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.action_play:
                    ...
                    Task taskList = (Task) mTaskAdapter.getItem(position);
                    text_to_speech = taskList.getDescription();
    ...
    private TextToSpeech initTextToSpeechService() {
        ...
        String username = "00014017-cd25-4907-a9a9-4d95d63c4a8a";
        String password = "rjHgD4lvJaWD";
    ...
    private class WatsonTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... textToSpeak) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    showProgressDialog(R.string.action_play, "Playing Notes!");
                }
            });
